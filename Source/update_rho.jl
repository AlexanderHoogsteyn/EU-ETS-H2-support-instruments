function update_rho!(ADMM::Dict, iter::Int64)
    if mod(iter,1) == 0
        ...
        if (ADMM["imbalance_mode"] == "QUANTITY" &&  ADMM["Residuals"]["Primal"]["H2CN_prod"][end] > 2*ADMM["Residuals"]["Dual"]["H2CN_prod"][end]) ||
            (ADMM["imbalance_mode"] == "CAPACITY" && ADMM["Residuals"]["Primal"]["H2CN_cap"][end] > 2*ADMM["Residuals"]["Dual"]["H2CN_cap"][end])
                push!(ADMM["ρ"]["H2CN_prod"], minimum([1000,1.1*ADMM["ρ"]["H2CN_prod"][end]]))
                push!(ADMM["ρ"]["H2CN_cap"], minimum([1000,1.1*ADMM["ρ"]["H2CN_prod"][end]]))
                push!(ADMM["ρ"]["H2FP"], minimum([1000,1.1*ADMM["ρ"]["H2FP"][end]]))
                push!(ADMM["ρ"]["H2CfD"], minimum([1000,1.1*ADMM["ρ"]["H2CfD"][end]]))
                push!(ADMM["ρ"]["H2CG"], minimum([1000,1.1*ADMM["ρ"]["H2CG"][end]]))
                push!(ADMM["ρ"]["H2TD"], minimum([1000,1.1*ADMM["ρ"]["H2TD"][end]]))
        elseif (ADMM["imbalance_mode"] == "QUANTITY" && ADMM["Residuals"]["Dual"]["H2CN_prod"][end] > 2*ADMM["Residuals"]["Primal"]["H2CN_prod"][end]) ||
               (ADMM["imbalance_mode"] == "CAPACITY" && ADMM["Residuals"]["Dual"]["H2CN_cap"][end] > 2*ADMM["Residuals"]["Primal"]["H2CN_cap"][end])
                ...
                push!(ADMM["ρ"]["H2CG"], 1/1.1*ADMM["ρ"]["H2CG"][end])
                push!(ADMM["ρ"]["H2TD"], 1/1.1*ADMM["ρ"]["H2TD"][end])
        else
            push!(ADMM["ρ"]["H2CN_prod"], ADMM["ρ"]["H2CN_prod"][end])
            push!(ADMM["ρ"]["H2CN_cap"], ADMM["ρ"]["H2CN_cap"][end])
            push!(ADMM["ρ"]["H2FP"], ADMM["ρ"]["H2FP"][end])
            push!(ADMM["ρ"]["H2CfD"], ADMM["ρ"]["H2CfD"][end])
            push!(ADMM["ρ"]["H2CG"], ADMM["ρ"]["H2CG"][end])
            push!(ADMM["ρ"]["H2TD"], ADMM["ρ"]["H2TD"][end])
        end
    end
end