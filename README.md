...
Example for a simple single scenario run
```
#!/bin/bash -l
#!/bin/bash -l
#SBATCH --cluster="wice"
...
```
Example for a multiple scenario using batch submission
```
#!/bin/bash -l
#SBATCH --cluster="wice"
#SBATCH --nodes="1"
...
```
Example for a multiple sensetivities using batch submission
```
#!/bin/bash -l
#SBATCH --cluster="wice"
#SBATCH --nodes="1"
